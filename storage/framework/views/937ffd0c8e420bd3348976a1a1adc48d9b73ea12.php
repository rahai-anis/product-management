...
} elseif ($_instance->childHasBeenRendered('jUonihM')) {
    $componentId = $_instance->getRenderedChildComponentId('jUonihM');
    $componentTag = $_instance->getRenderedChildComponentTagName('jUonihM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jUonihM');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('jUonihM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/anis/Bureau/product-management/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>