...
} elseif ($_instance->childHasBeenRendered('UH0nR9W')) {
    $componentId = $_instance->getRenderedChildComponentId('UH0nR9W');
    $componentTag = $_instance->getRenderedChildComponentTagName('UH0nR9W');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UH0nR9W');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('UH0nR9W', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('yrvFeUk')) {
    $componentId = $_instance->getRenderedChildComponentId('yrvFeUk');
    $componentTag = $_instance->getRenderedChildComponentTagName('yrvFeUk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yrvFeUk');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('yrvFeUk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/anis/Bureau/product-management/vendor/filament/filament/src/../resources/views/components/topbar.blade.php ENDPATH**/ ?>