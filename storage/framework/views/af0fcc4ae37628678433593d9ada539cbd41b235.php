...
} elseif ($_instance->childHasBeenRendered('wkox8y4')) {
    $componentId = $_instance->getRenderedChildComponentId('wkox8y4');
    $componentTag = $_instance->getRenderedChildComponentTagName('wkox8y4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wkox8y4');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('wkox8y4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('U2lYSxt')) {
    $componentId = $_instance->getRenderedChildComponentId('U2lYSxt');
    $componentTag = $_instance->getRenderedChildComponentTagName('U2lYSxt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('U2lYSxt');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('U2lYSxt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/anis/Bureau/product-management/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>